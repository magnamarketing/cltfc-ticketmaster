<script type="text/javascript" src="//cdn.evgnet.com/beacon/charlottefc/cltfc_staging/scripts/evergage.min.js"></script>
        ...
        if (typeof SalesforceInteractions != 'undefined') {
            ...
            SalesforceInteractions.init({
                ...
                SalesforceInteractions.initSitemap({
                    ...
                    pageTypes: [
                        {
                            name: 'TicketMaster CLTFC Specific Event - Branded Page',
                            interaction: {
